; TO BE COMPILED WITH SJASMPLUS
            ...
            ; --- AUTOEXEC.AGD data
            define      LOAD_ADDRESS      $6100 ; Address where to load AUTOEXEC.BIN file
            define      LOAD_SIZE         $FFFF-$6100 ; Size of the AUTOEXEC.BIN file (if size if larger than file, file is loaded anyway)
            define      START_ADDRESS     $6100 ; Start address to run the game
